...
public class ActionsWithItems {
   ...
   public void findItem() {
        System.out.println("Write the id of item");
    ...
    */
    ...
    public void addItem() throws SQLException {
        ...
        System.out.println("Enter category of device (1 - Tablet, 2 - SmartPhone, 3 - SmartWatch, 4 - PC, 5 - Mobile Phone, 6 - Laptop, 7 - Fitness Braclet): ");
        command = scanner.nextInt();
        switch (command) {
        ...
        System.out.println("Enter brand of device (Write it correct): ");
        brand = scanner.next().trim();
        System.out.println("Enter model of device (Write it correct): ");
