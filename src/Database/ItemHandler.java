...
public class ItemHandler extends DBhandler {
    ...
    public void listOfItems() throws SQLException {
        Connection connection = getConnection();
        String listOfItems = "SELECT * FROM " + itemsTable + "WHERE belongs_to is null;";
        ...
        while (resultSet.next()) {
            ...
            System.out.println("Id: " + id + "; General category: " + generalCategory + "; Category: " + category + "; Subcategory: " + subcategory + "; Model: " + model + "; Price: " + price);
        }
        connection.close();
    }
    ...
    public void searchItem(String category) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            String model = resultSet.getString("model");
            double price = resultSet.getDouble("price");
            System.out.println("Id: " + id + "; General category: " + generalCategory + "; Category: " + category2 + "; Subcategory: " + subcategory + "; Model: " + model + "; Price: " + price);
        }
        connection.close();
    }
    ...
    public void checkPrice(String login) {
